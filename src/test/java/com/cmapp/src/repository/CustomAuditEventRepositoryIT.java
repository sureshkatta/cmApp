...
import com.cmapp.src.config.audit.AuditEventConverter;
import com.cmapp.src.domain.PersistentAuditEvent;
...
import static com.cmapp.src.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
